...
character.name = "nidalee"
character.model = "models/heroes/nidalee/nidalee.mdl"
character.move_allow_forward45 = false   
character.spells = { 
	{"l_attack_ranged"},    
	{"nidalee_transform_cat"},  
}
character.stats = {
	//{base,perLevel}
	health = {511,80}, 
...
function character:Behavior(ply,b)
	...
	b:NewState("spell4",function(s,e) BGACT.ABCAST(e,"nidalee_transform_cat")   return 0.01 end) 
